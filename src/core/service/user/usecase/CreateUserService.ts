...
import { CreateUserUseCase } from '@core/domain/user/usecase/CraeteUserUseCase';
...
export class CreateUserService implements CreateUserUseCase {
  ...
  public async execute(payload: CreateUserPort): Promise<UserUseCaseDto> {
    ...
    CoreAssert.isFalse(doesUserExist, Exception.new({ code: Code.ENTITY_ALREADY_EXISTS, overrideMessage: 'User already exists.' }));
